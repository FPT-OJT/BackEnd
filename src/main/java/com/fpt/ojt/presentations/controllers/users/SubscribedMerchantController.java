...
public class SubscribedMerchantController extends AbstractBaseController {
    ...
    @Operation(
            summary = "Get subscribed merchants",
            description = "Retrieve all merchants that the current user has subscribed to")
    @GetMapping
    ...
    @Operation(
            summary = "Get subscribed merchant agencies",
            description = "Retrieve all merchant agencies that the current user has subscribed to")
    @GetMapping("/agencies")
    ...
    @Operation(
            summary = "Toggle subscribed merchant agency",
            description = "Toggle the current user's subscription to a specific merchant agency")
    @PostMapping("/agencies/{merchantAgencyId}")
    public ResponseEntity<SingleResponse<Boolean>> toggleSubscribedMerchantAgency(
            @Parameter(description = "UUID of the merchant agency to subscribe to", required = true) @PathVariable
    ...
    @Operation(
            summary = "Unsubscribe from merchant agency",
            description = "Unsubscribe the current user from a specific merchant agency")
    @DeleteMapping("/agencies/{merchantAgencyId}")
    public ResponseEntity<SingleResponse<Void>> unsubscribeMerchantAgency(
            @Parameter(description = "UUID of the merchant agency to unsubscribe from", required = true) @PathVariable
                    UUID merchantAgencyId) {
    ...
    public ResponseEntity<SingleResponse<Void>> subscribeMerchant(
            @Parameter(description = "UUID of the merchant to subscribe to", required = true) @PathVariable
                    UUID merchantId) {
    ...
    @Operation(
            summary = "Unsubscribe from merchant",
            description = "Unsubscribe the current user from a specific merchant")
    @DeleteMapping("/{merchantId}")
    public ResponseEntity<SingleResponse<Void>> unsubscribeMerchant(
            @Parameter(description = "UUID of the merchant to unsubscribe from", required = true) @PathVariable
                    UUID merchantId) {
    ...
    public ResponseEntity<SingleResponse<Boolean>> isSubscribedMerchantAgency(
            @Parameter(
                            description = "UUID of the merchant agency to check if the current user is subscribed to",
                            required = true)
                    @PathVariable
                    UUID merchantAgencyId) {
        var isSubscribed =
                subscribedMerchantService.isSubscribedMerchantAgency(authService.getCurrentUserId(), merchantAgencyId);
