                ...
                try (var executor = Executors.newVirtualThreadPerTaskExecutor()) {
                        var offerFutures = availableCardRulesDtos.stream()
                                        .flatMap(cardDto -> cardDto.getCardRules().stream()
                                                        .flatMap(cardRule -> {
                                                                double cardBenefit = dealService
                                                                                .calculateCardOnlyBenefit(cardRule);
                                                                // Skip if no benefit
                                                                if (cardBenefit <= 0) {
                                                                        return Stream.empty();
                                                                }
                                                                ...
                                                                if (allowMccs == null && rejectMccs == null) {
                                                                        List<MerchantAgency> agencies = merchantAgencyRepository
                                                                                        .findAllActiveWithMerchant();
                                                                        ...
                                                                        return agencies.stream()
                                                                                        .map(agency -> executor
                                                                                                        .submit(() -> {
                                                                                                                ...
                                                                                                                var isSubscribedFuture = executor
                                                                                                                                .submit(() -> subscribedMerchantRepository
                                                                                                                                                .existsByUserIdAndMerchantAgencyId(
                                                                                                                                                                currentUserId,
                                                                                                                                                                agency.getId()));

                                                                                                                boolean isFavorite = isFavoriteFuture
                                                                                                                                .get();
                                                                                                                boolean isSubscribed = isSubscribedFuture
                                                                                                                                .get();

                                                                                                                return MerchantOfferDto
                                                                                                                                .builder()
                                                                                                                                .merchantAgencyId(
                                                                                                                                                agency.getId())
                                                                                                                                .merchantAgencyName(
                                                                                                                                                agency.getName())
                                                                                                                                .mcc(agency.getMerchant()
                                                                                                                                                .getMcc())
                                                                                                                                .imageUrl(agency.getImageUrl())
                                                                                                                                .merchantDealName(
                                                                                                                                                "Card Benefit: " + String
                        ...
                        return merchantOfferDtos.stream()
                                        .collect(java.util.stream.Collectors.toMap(
                                                        ...
                                                        (existing, replacement) -> existing
                                                                        .getTotalDiscount() >= replacement
                                                                                        .getTotalDiscount() ? existing
                                                                                                        : replacement))
                                        .values()
                                        .stream()
                                        .sorted((o1, o2) -> Double.compare(
